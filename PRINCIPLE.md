...
<Button size="lg">
  ...
  <SearchIcon variant="filled" /> // variant로 시각적 강조 수준 표현 검색
</Button>
```
...
```tsx
<button
  className="bg-primary data-active:scale-[0.98] data-disabled:opacity-50 data-focus-visible:outline-2 data-hovered:ring-2"
  {...dataProps}
>
  {children}
</button>
